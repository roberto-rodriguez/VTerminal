...
public class SettingsHelperClass {
    ...
    public static boolean processEditTextPreference(String settingKey, String settingVal, SettingValues values) {
        values.clear();
    ...
    public static void processListPreference(String settingKey, String settingVal, SettingValues values) {
        values.clear();
    ...
    public static ImageProcessorConfiguration getImageProcessorConfiguration(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static DeviceDeclinationResult getDeviceDeclinationValue(Context context, String declinationKey) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
